...
source("R/exts_xaringan_r_setup.R")
```
...
- And you can use icons of the following libraries:     
  ...
  - `r icon::fontawesome("user-graduate")` [`academicons()`](https://jpswalsh.github.io/academicons/):  e.g. `doi`, `moodle`, etc<sup>*</sup>.

.footnote[
[*]  Currently it the things are 
]
---
...
```{r}
countdown(minutes = 0, seconds = 15, left = 0)
```
