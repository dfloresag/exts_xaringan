...
# `r icon::fontawesome("download", style = "solid")` Installation 

---

# `r icon::fontawesome("download", style = "solid")` Installation 

- The `{xaringan}` package is on [CRAN](https://cran.r-project.org/web/packages/xaringan/index.html) and the development version on the [github repo](https://github.com/yihui/xaringan)
...
- The `exts_xaringan` [github repo](https://github.com/dfloresag/exts_xaringan) contains this template, as well as the assets: 
...
- Icons can be inserted  _inline_ using the package `{icon}`

    - `r icon::simple_icons("github")` :  `icon::simple_icons("github")`     
    
    -  Here is full list of [`fontawewsome`](https://fontawesome.com/icons?d=gallery), [`simpleicons`](https://simpleicons.org/?q=html) and [academicicons](https://jpswalsh.github.io/academicons/)
...
---
# `r icon::fontawesome("thumbs-up", style = "solid")` What's .red[good] about `{xaringan}`? 

--

### `r icon::simple_icons("javascript")` based on [`remark.js`](https://remarkjs.com/#1)

### `r icon::simple_icons("markdown")` Mardown typsetting

### `r icon::simple_icons("css3")` Easy customisation with CSS style sheets.

### `r icon::simple_icons("r")` Well integrated with `R`

### `r icon::simple_icons("html5")` Rendered in `html` and easily deployed on the web

---
# `r icon::fontawesome("thumbs-up", style = "solid")` What's .red[good] about `{xaringan}`? 

### `r icon::fontawesome("keyboard", style = "solid")` Keyboard shortcuts
...
# `r icon::fontawesome("keyboard", style = "solid")` Some Syntax
...
# `r icon::fontawesome("images", style = "solid")` Background Images
...
---
# `r icon::fontawesome("palette", style = "solid")` Colored Elements
...
---
# `r icon::simple_icons("r")` Code Execution
...
---
# `r icon::fontawesome("code")` HTML Widgets
...
- The title slide is set to `class: center, middle, section, title-slide` by default. You can change the classes applied to the title slide with the `titleSlideClass` option of `nature` (`title-slide` is always applied).

    ```yaml
    output:
      xaringan::moon_reader:
        nature:
          titleSlideClass: [top, left, section]
    ```
